Pod::Spec.new do |spec|
    ...
    spec.source       = { :http => "https://mkplayer.z13.web.core.windows.net/ios_tvos/MKPlayer-1.41.0-a.2.zip" }
    ...
    spec.ios.dependency 'BitmovinPlayer', '3.92.0-a.1'
    ...
    spec.tvos.dependency 'BitmovinPlayer', '3.92.0-a.1'
